...
//           >
//             &copy; {currentYear}{" "}
//             <a href="https://material-tailwind.com/">Nepal Insight</a>. All
//             Rights Reserved.
//           </Typography>
  ...
  return (
    <footer className="bg-gray-100 text-gray-600 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:ml-28 justify-center lg:grid-cols-4 gap-8">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-center md:text-left mb-4 md:mb-0">
              © {new Date().getFullYear()} Nepal Insight. All Rights Reserved.
            </p>
